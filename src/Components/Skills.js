...
export default function Skills() {
  ...
  return (
    <div className='pt-20 -mt-24 mb-8 z-50 h-full' id='skills'>
      ...
      >
        Tech
        <h1 className='color_animate'>&nbsp;Stack</h1>
      </h1>
        ...
        <div className="w-[70%] mx-auto">
          ...
          >
            {list.map(({ name, icon }, index) => (
              <motion.div
                key={index}
                className="bg-custom-mylight dark:bg-custom-myblack px-4 py-2 rounded-md myshadow flex items-center gap-2 cursor-pointer hover:scale-105 transition-transform duration-200"
