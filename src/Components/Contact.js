          ...
          <section className="relative w-full min-h-screen bg-custom-mylight dark:bg-custom-myblack text-custom-myblack dark:text-custom-mylight">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-custom-myblack dark:bg-custom-mylight h-32 w-full rounded-full"></div>
              ...
              <div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center ">
                ...
                <div class="bg-custom-mylight dark:bg-custom-myblack myshadow border border-blue-600 w-full lg:w-1/2 h-full p-5 pt-8">
                    <h3 class="text-2xl font-custom mb-5">
                    My Social Media
                    </h3>
                    {/* <!-- list --> */}
                    <div class="flex flex-col gap-3 font-custom">
                    <a href="https://github.com/SK-code-stack" target='blank' class="flex items-center hover:text-white hover:bg-blue-600 p-2">
                    ...
                    <a href="https://www.linkedin.com/in/salman-khan-cw/" target='blank' class="flex items-center hover:text-white hover:bg-blue-600 p-2">
              ...
              {/* Contact Form */}
              <form ref={form} onSubmit={sendEmail} className="w-full md:w-1/2 myshadow border border-blue-600 p-6 bg-custom-mylight dark:bg-custom-myblack font-custom">
                <h2 className="text-2xl pb-3 font-custom">Send Message</h2>
                <div>
